...
| [de-ai-doc](./de-ai-doc/SKILL.md) | Update one or more documentation files in place to replace AI-heavy writing with concise, natural, technically precise prose while preserving facts, code, structure, and author intent. |
...
Grill-Me, Write-A-Prd, Write-A-Skill are based on Matt Pocock's work, with additions:
