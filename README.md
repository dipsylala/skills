...
| [write-a-prd](./write-a-prd/SKILL.md) | Create a PRD from user context, focused questions, and available repository evidence, with scope and acceptance criteria. |
