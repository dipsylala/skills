...
All scripts automatically handle schema variations:
- **Pascal case** fields: `Severity`, `ID`, `Title`
- **lowercase** fields: `severity`, `id`, `title`
- **snake_case** fields: `primary_url`

This ensures the scripts work across different Veracode versions and scanner integrations.
